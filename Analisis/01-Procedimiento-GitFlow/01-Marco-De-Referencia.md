...
| **C-4** | Producto con varias versiones vivas | ¿Se sostienen dos o más versiones en paralelo? | Cambia el modelo de ramas completo: es el contexto donde GitFlow sigue siendo razonable |
...
Dos separaciones que la guía sostiene en todos los escenarios:

**Quien escribe el cambio no declara que está verificado.** El desarrollador cierra su parte con el
merge; el issue lo cierra A-QA cuando lo valida. Mergeado no es verificado.

**Quien construye el artefacto no autoriza su liberación.** A-OPS produce y promociona; A-AUT
...
> A-QA, en esta guía, nombra la función, no un puesto.
...
> preaprobados, y rutear todo por el comité está identificado explícitamente como antipatrón.
