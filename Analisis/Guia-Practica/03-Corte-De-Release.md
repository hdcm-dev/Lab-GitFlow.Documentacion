...
[plantilla de registro de release](../Modelo-Ramas/Anexos/Plantillas.md). Los dos tramos se anclan a fechas, no a
...
[07](../Modelo-Ramas/07-Integracion-Y-Versionado.md).
...
4. **Promoción del artefacto (I1).** Se despliega a producción **el binario de `v1.0.0-rc1`**, no una
   ...
   esa candidata. Ver [07](../Modelo-Ramas/07-Integracion-Y-Versionado.md).
