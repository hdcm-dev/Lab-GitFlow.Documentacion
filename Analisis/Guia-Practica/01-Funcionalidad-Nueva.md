...
Se abre el pull request **en borrador**, con la [plantilla](../Modelo-Ramas/Anexos/Plantillas.md) completa. El
...
- **El commit único en `main`.** `git log --oneline -3` después del merge: un commit por issue.
  ...
  en su alcance —[06](../Modelo-Ramas/06-Modelo-Adoptado.md)—. Es el commit que el escenario 02 va a mostrar en
